...
# Setup Ardusub
RUN --mount=type=bind,source=src/surface/rov_gazebo/scripts/ardusub.sh,target=/tmp/ardusub.sh \
  . /tmp/ardusub.sh

# Setup Ardupilot Gazebo
RUN --mount=type=bind,source=src/surface/rov_gazebo/scripts/ardupilot_gazebo.sh,target=/tmp/ardupilot_gazebo.sh \
  . /tmp/ardupilot_gazebo.sh
