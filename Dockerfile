...
RUN --mount=type=bind,source=src/surface/rov_gazebo/scripts/add_models_and_worlds.sh,target=/tmp/src/surface/rov_gazebo/scripts/add_models_and_worlds.sh \
  . /tmp/src/surface/rov_gazebo/scripts/add_models_and_worlds.sh
