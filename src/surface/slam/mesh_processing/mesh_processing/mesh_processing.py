...
#                                 "coral_viewer_unity", "Build",
#                                 "coral_viewer_Data", "StreamingAssets",
#                                 "coral_output.obj")
...
class PCDListener(Node):
    ...
    def listener_callback(self, msg):
        ...
        self.pcd.colors = o3d.utility.Vector3dVector(
            numpy.flip(pcd_as_numpy_array[:, 3:], axis=1) / 255.0)

        self.pcd.estimate_normals()
        self.pcd.orient_normals_to_align_with_direction([0, 1, 0])
        self.mesh, densities = o3d.geometry.TriangleMesh\
            .create_from_point_cloud_poisson(pcd=self.pcd, depth=9)
        ...
        # # Give the obj file a txt extension so it can be
        # #  parsed manually in Unity
        # # This is necessary because the obj standard doesn't include colors,
        # #  so the open3d output isn't a proper obj
        # try:
