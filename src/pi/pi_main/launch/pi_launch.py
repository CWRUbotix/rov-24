...
def generate_launch_description() -> LaunchDescription:
    ...
    # Heartbeat
    pi_diagnostics_path = get_package_share_directory('pi_diagnostics')

    pi_diagnostics_launch = IncludeLaunchDescription(
        PythonLaunchDescriptionSource([
            os.path.join(
                pi_diagnostics_path, 'launch', 'pi_diagnostics_launch.py'
            )
        ])
    )
